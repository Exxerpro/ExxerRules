// <copyright file="EnumModel.cs" company="PlaceholderCompany">
...
// CLAUDE
// Date: 25/08/2025
// Reason: EF Core entity interface fix - EnumModel base class needs ILookupEntity to fix all enum DbSet registrations
