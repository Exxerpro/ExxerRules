...
/// </summary>
//TODO [BEST PRACTICE][CURSOR][20/JUNE/2025] - Validate PlcMananger logic and handle edge cases defensively. Ensure all required properties are set and handle missing/invalid values gracefully.
/// <summary>
/// Represents the PlcMananger.
/// </summary>
public class PlcMananger(ILogger logger) : IPlcManager
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="IReadOnlyDictionary<int">The IReadOnlyDictionary.<int.</param>
    /// <param name="plcsData">The plcsData.</param>
    /// <param name="IReadOnlyDictionary<int">The IReadOnlyDictionary.<int.</param>
    /// <param name="IReadOnlyDictionary<string">The IReadOnlyDictionary.<string.</param>
    /// <param name="performanceTags">The performanceTags.</param>
