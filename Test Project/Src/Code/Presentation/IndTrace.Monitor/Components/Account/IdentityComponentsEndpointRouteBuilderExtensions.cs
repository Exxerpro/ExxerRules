...
{
    /// <summary>
    /// Maps additional Identity endpoints required by the Identity Razor components defined in the /Components/Account/Pages directory.
    /// </summary>
    /// <param name="endpoints">The endpoint route builder to extend.</param>
    /// <returns>An endpoint convention builder for the mapped endpoints.</returns>
