...
public static class ServiceRegistration
{
    ...
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IPlcDetailDataLoader>(sp =>
        {
            ...
            var machinePlcRepository = sp.GetRequiredService<IRepository<MachinePlc>>();
        ...
        // Reports Filter Info Service
        services.AddScoped<IReportsFilterInfoBuilder>(sp =>
        {
            var flowStatusRepository = sp.GetRequiredService<IRepository<FlowStatus>>();
            ...
            return new ReportsFilterInfoBuilder(flowStatusRepository, customerRepository,
        ...
        {
            var logger = sp.GetRequiredService<ILogger<IndTrace.Application.Cycles.Validation.StationValidator>>();
            return new IndTrace.Application.Cycles.Validation.StationValidator(logger);
        });
        ...
        services.AddScoped<ICycleCreator>(sp =>
        {
            ...
            return new CycleCreator(cycleRepository, logger);
        });

        services.AddScoped<IBarCodeUpdater>(sp =>
        {
            var barCodeRepository = sp.GetRequiredService<IRepository<BarCode>>();
            var logger = sp.GetRequiredService<ILogger<BarCodeUpdater>>();
            return new BarCodeUpdater(barCodeRepository, logger);
        });
    ...
    public static IServiceCollection AddBarCodeHandlers(this IServiceCollection services)
    {
        ...
        services.AddScoped<IMonitorQueryHandler<GetReportsFilterInfoQuery, ReportsFilterInfoVm>>(sp =>
        {
            ...
            return new GetReportesFilterInfoMonitorQueryHandler(builder, logger);
        });
    ...
    public static IServiceCollection AddCyclesCommandHandlers(this IServiceCollection services)
    {
        ...
        services.AddScoped<IGatewayRequestHandler<CreateCyclesCommand, TaskGatewayResponse>>(sp =>
        {
            ...
            return new CreateCyclesCommandHandler(logger, dateTimeMachine, barCodeResult,
                stationValidator, cycleLimitPolicy, cycleCreator, barCodeUpdater, gatewayAuditFactory);
        });
