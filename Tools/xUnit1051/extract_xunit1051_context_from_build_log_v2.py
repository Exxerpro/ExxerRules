"""
Extract xUnit1051 warnings from a build log and include an extended code snippet below each.

What it does
- Parses a build report for xUnit1051 warnings
- Extracts file + line, then prints 4 lines after the match for context
- Writes the report to xunit1051_context_report.txt

How to run
    python extract_xunit1051_context_from_build_log_v2.py
"""
