...
/// <summary>
/// Removes unused using directives from C# source files.
/// </summary>
[McpServerToolType]
public static class CleanupUsingsTool
{
    /// <summary>
    /// Cleans up unused using directives either using a solution context or operating on a single file.
    /// </summary>
    /// <param name="solutionPath">Optional absolute path to the solution file (.sln).</param>
    /// <param name="filePath">Path to the C# file to clean.</param>
    ...
    /// <summary>
    /// Removes unused using directives from the provided C# source text.
    /// </summary>
    /// <param name="sourceText">C# source text to analyze.</param>
    /// <returns>Updated source text with unused usings removed.</returns>
