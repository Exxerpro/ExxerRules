...
{
    /// <summary>
    /// Converts an instance method to an extension method and leaves a delegating wrapper.
    /// </summary>
    ...
    /// <param name="extensionClass">Optional extension class name.</param>
    ...
    /// <summary>
    /// Transforms an instance method in source text into a static extension method and adds a wrapper.
    /// </summary>
    /// <param name="sourceText">Original source text.</param>
    /// <param name="methodName">Name of the instance method to convert.</param>
    /// <param name="extensionClass">Optional extension class name to host the method.</param>
