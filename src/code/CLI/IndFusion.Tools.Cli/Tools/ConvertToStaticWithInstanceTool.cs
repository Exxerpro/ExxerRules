...
/// <summary>
/// Converts an instance method to static by introducing an explicit instance parameter.
/// </summary>
[McpServerToolType]
public static class ConvertToStaticWithInstanceTool
{
    ...
    /// <summary>
    /// Converts an instance method to static with an explicit instance parameter.
    /// </summary>
    ...
    /// <param name="instanceParameterName">Name of the instance parameter to add.</param>
    ...
    /// <summary>
    /// Converts an instance method in source text to a static method using an explicit instance parameter.
    /// </summary>
    /// <param name="sourceText">Original source text.</param>
    /// <param name="methodName">Name of the method to convert.</param>
    /// <param name="instanceParameterName">Identifier to use for the injected instance parameter.</param>
