...
/// <summary>
/// Introduces a new local variable from a selected expression and updates usages.
/// </summary>
[McpServerToolType]
public static class IntroduceVariableTool
{
    /// <summary>
    /// Introduces a new local variable from selected code in solution or single-file mode.
    /// </summary>
    ...
    /// <summary>
    /// Introduces a local variable directly in the provided source text.
    /// </summary>
    /// <param name="sourceText">Original source text.</param>
    /// <param name="selectionRange">Selected range for initialization.</param>
    /// <param name="variableName">Variable name to introduce.</param>
    /// <param name="model">Optional semantic model for type resolution.</param>
