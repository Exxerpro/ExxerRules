...
public static partial class MoveMultipleMethodsTool
{
    ...
    /// <summary>
    /// Moves methods and converts them to static with an explicit instance parameter.
    /// </summary>
    ...
    /// <summary>
    /// Moves methods and keeps them as instance methods, injecting source instance via constructor.
    /// </summary>
