...
/// <summary>
/// Analyzes a C# file for refactoring opportunities (e.g., long methods, unused code).
/// </summary>
[McpServerToolType, McpServerPromptType]
public static class AnalyzeExxerFactoringOpportunitiesTool
{
    /// <summary>
    /// Analyzes the given file and returns a list of suggested refactorings.
    /// </summary>
    ...
    /// <returns>A textual list of suggestions, or a message if none found.</returns>
