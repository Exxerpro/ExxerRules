...
/// <summary>
/// Creates a simple decorator class that wraps calls to an existing method.
/// </summary>
[McpServerToolType]
public static class ExtractDecoratorTool
{
    /// <summary>
    /// Generates a decorator class and updates code to use it where appropriate.
    /// </summary>
    ...
    /// <summary>
    /// Creates the decorator class directly in the provided source text.
    /// </summary>
    /// <param name="sourceText">Original source text.</param>
    /// <param name="className">Name of the class containing the method to decorate.</param>
    /// <param name="methodName">Name of the method to be decorated.</param>
    /// <returns>Updated source text including the decorator class.</returns>
