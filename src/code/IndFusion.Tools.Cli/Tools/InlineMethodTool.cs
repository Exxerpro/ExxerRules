...
/// <summary>
/// Inlines a method at its call sites and removes the original definition.
/// </summary>
[McpServerToolType]
public static class InlineMethodTool
{
    ...
    /// <summary>
    /// Inlines the specified method directly in the provided source text and removes the definition.
    /// </summary>
    ...
    /// <summary>
    /// Inlines a method in a document and removes its definition, updating all call sites.
    /// </summary>
