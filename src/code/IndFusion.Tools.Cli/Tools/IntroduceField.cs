...
{
    /// <summary>
    /// Introduces a new field from a selected expression, moving initialization and updating references.
    /// </summary>
    ...
    /// <summary>
    /// Introduces a field directly in provided source text.
    /// </summary>
    /// <param name="sourceText">Original source text.</param>
    /// <param name="selectionRange">Selected range to extract.</param>
    /// <param name="fieldName">Field name to introduce.</param>
    /// <param name="accessModifier">Desired access modifier.</param>
