...
/// <summary>
/// Provides metrics gathering and caching for C# files in a solution.
/// </summary>
...
public static class MetricsProvider
{
    ...
    /// <summary>
    /// Recomputes metrics for a file and updates cache.
    /// </summary>
