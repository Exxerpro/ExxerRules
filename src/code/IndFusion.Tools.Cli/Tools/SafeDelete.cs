...
public static class SafeDeleteTool
{
    ...
    /// <summary>
    /// Deletes a method if there are no usages; supports solution or single-file mode.
    /// </summary>
    ...
    /// <summary>
    /// Deletes a parameter from a method if safe to do so.
    /// </summary>
    ...
    /// <summary>
    /// Deletes a local variable within the specified selection range when safe.
    /// </summary>
    ...
    /// <summary>
    /// Deletes a field from source text after verifying it has no references.
    /// </summary>
    ...
    /// <summary>
    /// Deletes a parameter from a method in source text after verifying it is unused.
    /// </summary>
    /// <param name="sourceText">Original source text.</param>
    ...
    /// <summary>
    /// Deletes a local variable within the specified selection range in source text.
    /// </summary>
    /// <param name="sourceText">Original source text.</param>
    /// <param name="selectionRange">Range of the declaration to remove.</param>
    /// <returns>Updated source text.</returns>
