...
/// <summary> /// Represents the  ExxerFactoringHelpersTests  class. /// </summary>
public class ExxerFactoringHelpersTests : IDisposable
{
    ...
    /// <summary> ///  ExxerFactoringHelpersTests. /// </summary>
    ...
    /// <summary> ///  TryParseRange WithValidRange ShouldReturnTrue. /// </summary>
    [Fact]
    ...
    /// <summary>
    /// TryParseRange WithInvalidRange ShouldReturnFalse.
    /// </summary>
    ...
    /// <summary> ///  ValidateRange WithValidRange ShouldReturnTrue. /// </summary>
    [Fact]
    ...
    /// <summary> ///  ValidateRange WithNonPositiveValues ShouldReturnFalse. /// </summary> /// <param name="startLine"></param> /// <param name="startColumn"></param> /// <param name="endLine"></param> /// <param name="endColumn"></param> /// <param name="expectedError"></param>
    [Theory]
    ...
    /// <summary> ///  ValidateRange WithInvalidRangeOrder ShouldReturnFalse. /// </summary>
    [Fact]
    ...
    /// <summary> ///  ValidateRange WithRangeExceedingFileLength ShouldReturnFalse. /// </summary>
    [Fact]
    ...
    /// <summary> ///  ApplySingleFileEdit WithValidTransform ShouldApplyChanges. /// </summary> /// <returns>A task that represents the asynchronous operation.</returns>
    [Fact]
    public async Task ApplySingleFileEdit_WithValidTransform_ShouldApplyChanges()
    {
        // Arrange
        var originalContent = "Original content";
        await File.WriteAllTextAsync(_testFilePath, originalContent, cancellationToken: Xunit.TestContext.Current.CancellationToken);
        ...
        var modifiedContent = await File.ReadAllTextAsync(_testFilePath, cancellationToken: Xunit.TestContext.Current.CancellationToken);
        modifiedContent.ShouldBe("Modified content");
    }

    /// <summary>
    /// ApplySingleFileEdit WithNonExistentFile ShouldThrowException().
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// ApplySingleFileEdit WithErrorTransform ShouldReturnError().
    /// </summary>
    [Fact]
    public async Task ApplySingleFileEdit_WithErrorTransform_ShouldReturnError()
    {
        // Arrange
        await File.WriteAllTextAsync(_testFilePath, "content", cancellationToken: Xunit.TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        var solution = await ExxerFactoringHelpers.GetOrLoadSolution(_testSolutionPath, cancellationToken: Xunit.TestContext.Current.CancellationToken);
    ...
    /// <summary>
    /// FindClassInSolution WithNonExistentClass ShouldReturnNull().
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// FindClassInSolution WithExcludedFilePath ShouldReturnNull().
    /// </summary>
    [Fact]
    ...
    /// <summary> /// GetOrParseSyntaxTreeAsync ShouldCacheAndReturnTree. /// </summary> /// <returns>A task that represents the asynchronous operation.</returns>
    [Fact]
    public async Task GetOrParseSyntaxTreeAsync_ShouldCacheAndReturnTree()
    {
        ...
        tree1.GetRoot(Xunit.TestContext.Current.CancellationToken).DescendantNodes().OfType<ClassDeclarationSyntax>().Count().ShouldBe(1);
    }

    /// <summary> /// GetOrCreateSemanticModelAsync ShouldCacheAndReturnModel. /// </summary> /// <returns>A task that represents the asynchronous operation.</returns>
    [Fact]
    ...
    /// <summary>
    /// UpdateFileCaches ShouldUpdateCachedData().
    /// </summary>
    [Fact]
    public void UpdateFileCaches_ShouldUpdateCachedData()
    {
        ...
        newTree!.GetRoot(Xunit.TestContext.Current.CancellationToken).DescendantNodes().OfType<ClassDeclarationSyntax>()
            .First().Identifier.Text.ShouldBe("NewClass");
    }

    /// <summary> ///  ReadFileWithEncodingAsync ShouldDetectUtf8Encoding. /// </summary> /// <returns>A task that represents the asynchronous operation.</returns>
    [Fact]
    public async Task ReadFileWithEncodingAsync_ShouldDetectUtf8Encoding()
    {
        // Arrange
        var content = "public class TestClass { }";
        await File.WriteAllTextAsync(_testFilePath, content, Encoding.UTF8, cancellationToken: Xunit.TestContext.Current.CancellationToken);

        // Act

        var (text, encoding) = await ExxerFactoringHelpers.ReadFileWithEncodingAsync(_testFilePath, cancellationToken: Xunit.TestContext.Current.CancellationToken);
    ...
    /// <summary> ///  ReadFileWithEncodingAsync ShouldDetectUtf8WithBom. /// </summary> /// <returns>A task that represents the asynchronous operation.</returns>
    [Fact]
    public async Task ReadFileWithEncodingAsync_ShouldDetectUtf8WithBom()
    {
        ...
        await File.WriteAllTextAsync(_testFilePath, content, utf8WithBom, cancellationToken: Xunit.TestContext.Current.CancellationToken);
    ...
    /// <summary> ///  WriteFileWithEncodingAsync ShouldWriteWithSpecifiedEncoding. /// </summary> /// <returns>A task that represents the asynchronous operation.</returns>
    [Fact]
    public async Task WriteFileWithEncodingAsync_ShouldWriteWithSpecifiedEncoding()
    {
        ...
        // Act
        await ExxerFactoringHelpers.WriteFileWithEncodingAsync(_testFilePath, content, encoding, cancellationToken: Xunit.TestContext.Current.CancellationToken);

        // Assert
        var (readText, readEncoding) = await ExxerFactoringHelpers.ReadFileWithEncodingAsync(_testFilePath, cancellationToken: Xunit.TestContext.Current.CancellationToken);
    ...
    /// <summary> /// RunWithSolutionOrFile WithDocumentNotInSolution ShouldUseSingleFile. /// </summary> /// <returns>A task that represents the asynchronous operation.</returns>
    [Fact]
    ...
    /// <summary> ///  ClearAllCaches ShouldClearAllCaches. /// </summary>
    [Fact]
    ...
    /// <summary>
    /// SharedWorkspace ShouldReturnSameInstance().
    /// </summary>
    [Fact]
...
{
    /// <summary> /// Represents the  TestClass  class. /// </summary>
