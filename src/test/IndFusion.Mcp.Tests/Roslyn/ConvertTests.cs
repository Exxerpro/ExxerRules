...
{
    /// <summary> ///  ConvertToExtensionMethodInSource TransformsMethod. /// </summary>
    [Fact]
...
public static class StringProcessorExtensions
{
    ...
    /// <summary> ///  ConvertToExtensionMethodInSource AppendsToExistingClass. /// </summary>
    [Fact]
...
public static class StringProcessorExtensions
{
    ...
    /// <summary> ///  ConvertToStaticWithInstanceInSource TransformsMethod. /// </summary>
    [Fact]
        ...
        var expected = @"class DataProcessor
{
    ...
    /// <summary> ///  ConvertToStaticWithParametersInSource TransformsMethod. /// </summary>
    [Fact]
        ...
        var expected = @"class Calculator
{
    ...
    /// <summary> ///  ConvertToStaticWithParametersInSource TrimsUnderscorePrefix. /// </summary>
    [Fact]
        ...
        var expected = @"class Calculator
{
    ...
    /// <summary> ///  ConvertToStaticWithInstanceInSource HandlesExplicitInterface. /// </summary>
    [Fact]
