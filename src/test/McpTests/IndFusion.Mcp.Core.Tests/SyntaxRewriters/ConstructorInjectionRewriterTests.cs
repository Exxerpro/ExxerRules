...
/// <summary>
/// Tests for ConstructorInjectionRewriter behaviors across method, invocation,
/// constructor and class declarations.
/// </summary>
public class ConstructorInjectionRewriterTests
{
    /// <summary>
    /// Verifies the target parameter is removed from the method declaration.
    /// </summary>
    [Fact]
...
public class TestClass
{
    public void TestMethod(string param1, int param2, bool param3)
    {
        ...
        // Act
        var tree = CSharpSyntaxTree.ParseText(sourceCode, cancellationToken: Xunit.TestContext.Current.CancellationToken);
        var root = tree.GetRoot(Xunit.TestContext.Current.CancellationToken);
    ...
    /// <summary>
    /// Verifies non-target methods are not modified.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Replaces parameter identifier usages with the injected field.
    /// </summary>
    [Fact]
...
public class TestClass
{
    public void TestMethod(string param1, int param2)
    {
        ...
        var assignment = constructor.Body!.Statements.OfType<ExpressionStatementSyntax>()
            .Select(s => s.Expression).OfType<AssignmentExpressionSyntax>().First();
        assignment.Right.ToString().ShouldBe("param2");
    }

    /// <summary>
    /// Leaves non-target parameter identifier usages unchanged.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Removes the corresponding argument from invocations of the target method.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Adds missing parameter and backing field when not present.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Does not add duplicate constructor parameters.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Adds a property for injection when configured to use properties.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Adds a field for injection when configured to use fields.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Does not add a duplicate field when it already exists.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Does not add a duplicate property when it already exists.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Adds an assignment statement to the constructor body.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Adds to an existing constructor body without removing statements.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Creates a body for a parameterless constructor when none exists.
    /// </summary>
    [Fact]
...
public class TestClass
{
    ...
    /// <summary>
    /// Handles invalid parameter indexes without throwing and leaves code valid.
    /// </summary>
    /// <param name="parameterIndex">The parameter index to attempt to remove.</param>
    [Theory]
    [InlineData(0)]
    [InlineData(2)]
    [InlineData(10)]
