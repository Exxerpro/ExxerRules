...
public partial class MoveMethodsTests
{
    private static string MoveMultipleMethodsInSource(
        ...
        bool[] isStatic)
    {
        var tree = CSharpSyntaxTree.ParseText(source, cancellationToken: Xunit.TestContext.Current.CancellationToken);
        ...
        var formattedRoot = Formatter.Format(root, workspace, options: null, cancellationToken: Xunit.TestContext.Current.CancellationToken);
...
public class TargetClass
{
        ...
        var formatted = Formatter.Format(finalRoot, new AdhocWorkspace(), options: null, cancellationToken: Xunit.TestContext.Current.CancellationToken).ToFullString();
...
public class TargetClass
{
    ...
    /// <summary> ///  MoveInstanceMethod OmitsUnusedThisParameter. /// </summary>
    [Fact]
...
public class TargetClass
{
    ...
    /// <summary> /// MoveInstanceMethod PrefixesEventHandlerWithThis. /// </summary>
    [Fact]
...
public class TargetClass
{
    ...
    /// <summary> ///  MoveInstanceMethod QualifiesBaseProperty. /// </summary>
    [Fact]
...
class Target { }";
    ...
    /// <summary> ///  MoveInstanceMethod RewritesThisArgument. /// </summary>
    [Fact]
...
public class Extracted { }";
    ...
    /// <summary> ///  MoveInstanceMethod QualifiesNestedClass. /// </summary>
    [Fact]
...
public class Target { }";
    ...
    /// <summary>
    /// MoveInstanceMethod QualifiesNestedClassReturn().
    /// </summary>
    [Fact]
...
class B { }";
    ...
    /// <summary> ///  MoveInstanceMethod QualifiesPublicNestedClass. /// </summary>
    [Fact]
...
public class B { }";
        ...
        var finalRoot = MoveMethodAst.AddMethodToTargetClass(result.NewSourceRoot, "B", result.MovedMethod, result.Namespace);
        var formatted = Formatter.Format(finalRoot, new AdhocWorkspace(), options: null, cancellationToken: TestContext.Current.CancellationToken).ToFullString();
    ...
    /// <summary> /// MoveInstanceMethod QualifiesPublicNestedEnum. /// </summary>
    [Fact]
...
public class B { }";
    ...
    /// <summary> ///  MoveInstanceMethod UpdatesPrivateDependencyAccess. /// </summary>
    [Fact]
...
public class Target { }";
    ...
    /// <summary> ///  MoveInstanceMethod QualifiesInterfaceMethod. /// </summary>
    [Fact]
...
class Target { }";
    ...
    /// <summary> ///  MoveInstanceMethod QualifiesBaseAfterInterface. /// </summary>
    [Fact]
...
class Target { }";
    ...
    /// <summary>
    /// MoveInstanceMethod QualifiesInterfacePropertyImplementedInBase().
    /// </summary>
    [Fact]
