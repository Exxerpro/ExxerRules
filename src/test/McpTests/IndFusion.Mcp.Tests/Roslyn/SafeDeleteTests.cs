...
{
    /// <summary> ///  SafeDeleteFieldInSource RemovesField. /// </summary>
    [Fact]
        ...
        var expected = @"class ConfigurationManager
{
    ...
    /// <summary> ///  SafeDeleteMethodInSource RemovesMethod. /// </summary>
    [Fact]
        ...
        var expected = @"class ServiceManager
{
    ...
    /// <summary> ///  SafeDeleteParameterInSource RemovesParameter. /// </summary>
    [Fact]
        ...
        var expected = @"class DataProcessor
{
    ...
    /// <summary> ///  SafeDeleteVariableInSource RemovesVariable. /// </summary>
    [Fact]
