...
/// <summary> /// Represents the  MoveMultipleMethodsTests  class. /// </summary>
public class MoveMultipleMethodsTests
{
        ...
        bool[] isStatic)
    {
        ...
        var formattedRoot = Formatter.Format(root, workspace, options: null, cancellationToken: TestContext.Current.CancellationToken);
        return formattedRoot.ToFullString();
    }

    /// <summary> ///  MoveMultipleMethods WithStaticMethods ShouldMoveCorrectly. /// </summary>
    [Fact]
...
public class TargetClass
{
    ...
    /// <summary> ///  MoveMultipleMethods WithInstanceMethods ShouldMoveCorrectly. /// </summary>
    [Fact]
...
public class TargetClass
{
    ...
    /// <summary> ///  MoveMultipleMethods WithMixedMethods ShouldMoveCorrectly. /// </summary>
    [Fact]
...
public class TargetClass
{
    ...
    /// <summary> ///  OrderOperations WithOverloadedMethods ShouldHandleDuplicates. /// </summary>
    [Fact]
...
";
    ...
    /// <summary> ///  DirectMoveMethod WithNamedArgumentsAndThisAccess ShouldSucceed. /// </summary>
    [Fact]
...
public class DepositManager
{
        ...
        var tree = CSharpSyntaxTree.ParseText(sourceCode, cancellationToken: TestContext.Current.CancellationToken);
    ...
    /// <summary> ///  DirectMoveMethod WithConditionalAccessInAssignment ShouldSucceed. /// </summary>
    [Fact]
...
public class DepositManager
{
    ...
    /// <summary> ///  DirectMoveMethod WithComplexLambdaAndNamedArgs ShouldSucceed. /// </summary>
    [Fact]
...
public class DepositManager
{
    ...
    /// <summary> ///  DirectMoveMethod WithNamedArgumentMemberAccess ShouldSucceed. /// </summary>
    [Fact]
