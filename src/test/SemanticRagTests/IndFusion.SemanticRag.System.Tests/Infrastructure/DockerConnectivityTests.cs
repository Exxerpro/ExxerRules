...
public sealed class DockerConnectivityTests
{
		...
		ITestOutputHelper output)
	{
		...
		_logger = XUnitLogger.CreateLogger<DockerConnectivityTests>(output);
	}
	...
	private static void SkipIfDockerUnavailable()
	{
		...
		{
			throw new TestSkippedException("Docker is not available - system tests require real containers");
		}
	}
